...
CREATE TABLE `Anexos` (
  ...
  `urlAnexo` varchar(255) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='define los anexos que estan alojados en google drive	';
...
INSERT INTO `Anexos` VALUES (12,'cotizacion','/adjuntos/4m02_historia.pdf',2,1,'2014-04-09 16:55:27',1,NULL),(13,'gantt de proyecto','/adjuntos/angular-app-master.zip',1,1,'2014-04-09 17:10:11',1,NULL),(14,'solicitud de proyecto','/adjuntos/angular-oauth-master.zip',4,1,'2014-04-09 22:27:12',1,NULL);
...
CREATE TABLE `Planificacion` (
  ...
  KEY `fk_proyectos_idx` (`idproyecto`),
  CONSTRAINT `fk_proyectos` FOREIGN KEY (`idproyecto`) REFERENCES `Proyecto` (`idProyecto`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2014-04-09 23:18:47
